...
public class ScrapAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.auctionapp.domain.scrap.view.ScrapAdapter.ScrapViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ((com.example.auctionapp.domain.scrap.view.ScrapAdapter.ScrapViewHolder)holder).onBind(scrapData.get(position));
    }
    ...
    // 리스너 객체 참조를 저장하는 변수
    private com.example.auctionapp.domain.scrap.view.ScrapAdapter.OnItemClickListener mListener = null ;
    public void setOnItemClickListener(com.example.auctionapp.domain.scrap.view.ScrapAdapter.OnItemClickListener onItemClickListener) {
