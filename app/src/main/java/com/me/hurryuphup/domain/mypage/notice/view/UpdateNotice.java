...
import com.me.hurryuphup.databinding.ActivityUpdateNoticeBinding;
import com.me.hurryuphup.databinding.ActivityUploadNoticeBinding;
...
public class UpdateNotice extends AppCompatActivity {
    ...
    public void init() {
        ...
        binding.editNoticeTitle.setText(title);
    ...
    private class UpdateNoticeCallback implements MainRetrofitCallback<UpdateNoticeResponse> {
        @Override
        public void onSuccessResponse(Response<UpdateNoticeResponse> response) {
            UpdateNoticeResponse result = response.body();
